    ...
    <div className=' bg-about font-barlow text-white flex justify-center pt-40 pb-24'>
        <div className=' w-[93%] 2xl:w-[70%] flex lg:flex-row flex-col justify-between'>
            <div className=' flex flex-col md:flex-row lg:flex-col items-center md:items-start justify-between lg:w-[40%] mb-10 lg:mb-0'>
                <div className=' font-light text-4xl text-center md:text-start md:text-6xl lg:text-5xl 2xl:text-6xl md:w-[80%] lg:w-80 mb-4 lg:mb-0'>WE ARE <span className=' font-bold text-green'>DEVELOPERS</span> PROMOTING AFR0<span className=' font-bold'>GAMES</span></div>
            ...
            <div>
                ...
                <div className=' md:absolute md:z-30 w-[70%]  md:h-48 left-14 md:-bottom-6 bg-about flex justify-center items-center'>
                        <div className=' whitespace-wrap w-full flex flex-wrap m-5   text-gray text-lg font-medium'>
                            <EffectText words={"Welcome to Afro Games and Comics (AFGC), a platform dedicated to showcasing the rich and diverse world of African gaming and comics. Our mission is to celebrate and promote African creativity in the gaming and comics industries, bringing to light the incredible talent and stories that originate from this vibrant continent. "} speed={0.006}/>
                        </div>
                    </div>
                    <div className=' md:mr-6 h-80 md:h-full overflow-hidden  md:mb-0 mb-16'><img src='/src/assets/images/mask_img1.jpg' className=' '/></div>
                    <div className=' sm:h-80  md:h-full overflow-hidden mb-2 md:md-0'><img src='/src/assets/images/mask_img2.jpg'/></div>
