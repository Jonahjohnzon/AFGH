...
import { openmenu } from "../feature/menu/slice";
    ...
    <AnimatePresence>
      {menu && (
        ...
        >
          ...
          <motion.div
            variants={child}
            className=" fixed w-[500px] bg-dak h-full right-0 top-0 z-50 flex flex-col items-center justify-between"
          >
            <div className=" w-[80%]">
              ...
              <div className=" text-3xl font-bold mt-[2vh]">
                <div>SEND AN EMAIL TO US</div>
                <div>
                  WE WILL <span className=" text-green">RESPOND</span>
                </div>
              </div>
              <div>
