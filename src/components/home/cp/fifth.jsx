...
const Fifth = ({ data }) => {
  ...
  return (
    <div className=' bg-[url("/assets/area_bg2.jpg")] bg-cover bg-center text-white font-barlow'>
          ...
          <div className="lg:pl-5 xl:pl-20">
            {inViewport && (
              ...
              >
                ...
                <div className='  bg-[url("/assets/images/_shape.png")] bg-cover bg-center absolute z-20 w-full h-full '>
                  <img
                    src="/assets/images/fun_.png"
