...
import Tab from '../../Tab'
import { eventz } from '../../test/testapi'
    ...
    <div className=' font-barlow flex justify-center'>
      <div className='w-5/6'>
        <div className='flex flex-col items-center'>
          <h6 className=' text-green font-bold mb-5 '><EffectText words={"EVENTS LIST"}/></h6>
          <h1 className=' font-bold text-3xl mb:text-5xl mb-5'>UPCOMING MATCHES</h1>
