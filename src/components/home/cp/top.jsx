  ...
  return (
    <div className=" w-full bg-[url('/src/assets/slider_bg.jpg')] flex pt-32 justify-center font-barlow relative">
      ...
      {/*buttons and wordings*/}
        <motion.div variants={anim} initial='hidden' animate='animate' className='flex flex-col items-center lg:items-start lg:mt-40 relative z-30'>
          <motion.div variants={children}  className=' bg-gradient-to-r mb-5 xs:mb-0 from-green/40 from-15% to-transparent  bg-opacity-20 rounded-md '>
            <div className=' text-green  text-2xl font-bold pl-5 py-2 pr-10 tracking-widest'>LIVE GAMING</div>
          </motion.div>
          <motion.div variants={children}  className='whitespace-nowrap tracking-tight text-[12.5vw] lg:text-[7.5vw] text-white -my-2 font-berlin 2xl:-my-7' style={{textShadow : "-1px 5px 1px #00FF7B"}}>STREAMING</motion.div>
          <motion.div variants={children}  className=' whitespace-nowrap text-2xl xs:text-3xl lg:text-4xl text-white font-bold lg:tracking-widest mb-10'>VIDEO GAMES ONLINE</motion.div>
          <motion.div variants={children} >
          <div className=' bg-green  hover:bg-white  px-10 text-center py-3 text-dark font-bold whitespace-nowrap rounded-md cursor-pointer mb-20 lg:mb-40 relative z-40'>CONTACT US</div></motion.div>
          <motion.div variants={children} className='hidden text-white lg:flex items-center font-bold font-berlin text-2xl'>
        ...
        {/*image*/}
        <div className=' hover:animate-wiggle flex justify-center'><img src='/src/assets/slider_img1.png' className='w-[85%] md:w-[70%] lg:w-[100%]'/></div>
      </div>
      {/* buttom design*/}
